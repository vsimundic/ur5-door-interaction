...
def image_callback(rgb,depth):
    ...
    if keyCounter == 1:
        ...
        cv2.imwrite("/home/RVLuser/ur5_ws/src/ao_manipulation/scripts/RGB_images/" + fileNameRGB, cv_image_rgb)
        cv2.imwrite("/home/RVLuser/ur5_ws/src/ao_manipulation/scripts/DEPTH_images/" + fileNameDEPTH, cv_image_depth)
        numberOfImages +=1
    if keyCounter >= 2:
...
def createPlyImages(counter):
    ...
    image_directory_name = '/home/RVLuser/ur5_ws/src/ao_manipulation/scripts/'
...
def buildModel(numberOfImages):
    ...
    f = open("/home/RVLuser/ur5_ws/src/ao_manipulation/scripts/models/doorModel.txt", "w")
    f.write(str(ao))
    f.close()
