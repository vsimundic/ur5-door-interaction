...
if __name__ == '__main__':
    # ani = animation.FuncAnimation(fig, animate, fargs=(xs, ys_x, ys_y, ys_z), interval=1000)
    ani = animation.FuncAnimation(fig, animate, interval=2)
    # ani2 = animation.FuncAnimation(fig_f, animate, interval=10)
    plt.show()

    # get_data_from_ft_sensor('192.168.10.14')