...
axs[0].set_title("Camera Perturbation Parameters", fontsize=12)
axs[0].set_xticks(x)
...
axs[1].set_title("Optimization Parameters", fontsize=12)
axs[1].set_xticks(x)
...
plt.tight_layout()
plt.savefig(os.path.join(analysis_dir, "simulation_ablation_camera_vs_correction_histogram.pdf"),
...
# Layout & Save
plt.tight_layout()
plt.savefig(os.path.join(analysis_dir, "simulation_ablation_camera_vs_correction_per_scene.pdf"),
            bbox_inches='tight', dpi=300)
plt.show()
